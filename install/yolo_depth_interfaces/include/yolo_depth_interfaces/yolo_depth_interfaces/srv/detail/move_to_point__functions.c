...
yolo_depth_interfaces__srv__MoveToPoint_Request__init(yolo_depth_interfaces__srv__MoveToPoint_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->target_position)) {
    yolo_depth_interfaces__srv__MoveToPoint_Request__fini(msg);
    return false;
  }
  return true;
}
...
yolo_depth_interfaces__srv__MoveToPoint_Request__create(void)
{
  ...
  yolo_depth_interfaces__srv__MoveToPoint_Request * msg = (yolo_depth_interfaces__srv__MoveToPoint_Request *)allocator.allocate(sizeof(yolo_depth_interfaces__srv__MoveToPoint_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yolo_depth_interfaces__srv__MoveToPoint_Request));
  bool success = yolo_depth_interfaces__srv__MoveToPoint_Request__init(msg);
  if (!success) {
...
yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__init(yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Request * data = NULL;

  if (size) {
    data = (yolo_depth_interfaces__srv__MoveToPoint_Request *)allocator.zero_allocate(size, sizeof(yolo_depth_interfaces__srv__MoveToPoint_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yolo_depth_interfaces__srv__MoveToPoint_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        yolo_depth_interfaces__srv__MoveToPoint_Request__fini(&data[i - 1]);
      }
...
yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__fini(yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      yolo_depth_interfaces__srv__MoveToPoint_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * array = (yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence *)allocator.allocate(sizeof(yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__init(array, size);
  if (!success) {
...
yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__destroy(yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__are_equal(const yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * lhs, const yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yolo_depth_interfaces__srv__MoveToPoint_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yolo_depth_interfaces__srv__MoveToPoint_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yolo_depth_interfaces__srv__MoveToPoint_Request * data =
      (yolo_depth_interfaces__srv__MoveToPoint_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolo_depth_interfaces__srv__MoveToPoint_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yolo_depth_interfaces__srv__MoveToPoint_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!yolo_depth_interfaces__srv__MoveToPoint_Request__copy(
...
yolo_depth_interfaces__srv__MoveToPoint_Response__init(yolo_depth_interfaces__srv__MoveToPoint_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    yolo_depth_interfaces__srv__MoveToPoint_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Response * msg = (yolo_depth_interfaces__srv__MoveToPoint_Response *)allocator.allocate(sizeof(yolo_depth_interfaces__srv__MoveToPoint_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yolo_depth_interfaces__srv__MoveToPoint_Response));
  bool success = yolo_depth_interfaces__srv__MoveToPoint_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__init(yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Response * data = NULL;

  if (size) {
    data = (yolo_depth_interfaces__srv__MoveToPoint_Response *)allocator.zero_allocate(size, sizeof(yolo_depth_interfaces__srv__MoveToPoint_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yolo_depth_interfaces__srv__MoveToPoint_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        yolo_depth_interfaces__srv__MoveToPoint_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__fini(yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      yolo_depth_interfaces__srv__MoveToPoint_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * array = (yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence *)allocator.allocate(sizeof(yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__destroy(yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__are_equal(const yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * lhs, const yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yolo_depth_interfaces__srv__MoveToPoint_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yolo_depth_interfaces__srv__MoveToPoint_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yolo_depth_interfaces__srv__MoveToPoint_Response * data =
      (yolo_depth_interfaces__srv__MoveToPoint_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolo_depth_interfaces__srv__MoveToPoint_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yolo_depth_interfaces__srv__MoveToPoint_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!yolo_depth_interfaces__srv__MoveToPoint_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
yolo_depth_interfaces__srv__MoveToPoint_Event__init(yolo_depth_interfaces__srv__MoveToPoint_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    yolo_depth_interfaces__srv__MoveToPoint_Event__fini(msg);
    return false;
  }
  // request
  if (!yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__init(&msg->request, 0)) {
    yolo_depth_interfaces__srv__MoveToPoint_Event__fini(msg);
    return false;
  }
  // response
  if (!yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__init(&msg->response, 0)) {
    yolo_depth_interfaces__srv__MoveToPoint_Event__fini(msg);
    return false;
  }
  return true;
...
yolo_depth_interfaces__srv__MoveToPoint_Event__fini(yolo_depth_interfaces__srv__MoveToPoint_Event * msg)
{
  ...
  // request
  yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__fini(&msg->request);
  // response
  yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__fini(&msg->response);
}
...
yolo_depth_interfaces__srv__MoveToPoint_Event__are_equal(const yolo_depth_interfaces__srv__MoveToPoint_Event * lhs, const yolo_depth_interfaces__srv__MoveToPoint_Event * rhs)
{
  ...
  // request
  if (!yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__are_equal(
  ...
  yolo_depth_interfaces__srv__MoveToPoint_Event * output)
{
  ...
  // request
  if (!yolo_depth_interfaces__srv__MoveToPoint_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!yolo_depth_interfaces__srv__MoveToPoint_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Event * msg = (yolo_depth_interfaces__srv__MoveToPoint_Event *)allocator.allocate(sizeof(yolo_depth_interfaces__srv__MoveToPoint_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yolo_depth_interfaces__srv__MoveToPoint_Event));
  bool success = yolo_depth_interfaces__srv__MoveToPoint_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence__init(yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Event * data = NULL;

  if (size) {
    data = (yolo_depth_interfaces__srv__MoveToPoint_Event *)allocator.zero_allocate(size, sizeof(yolo_depth_interfaces__srv__MoveToPoint_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yolo_depth_interfaces__srv__MoveToPoint_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        yolo_depth_interfaces__srv__MoveToPoint_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence__fini(yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      yolo_depth_interfaces__srv__MoveToPoint_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * array = (yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence *)allocator.allocate(sizeof(yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence__destroy(yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence__are_equal(const yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * lhs, const yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yolo_depth_interfaces__srv__MoveToPoint_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yolo_depth_interfaces__srv__MoveToPoint_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yolo_depth_interfaces__srv__MoveToPoint_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yolo_depth_interfaces__srv__MoveToPoint_Event * data =
      (yolo_depth_interfaces__srv__MoveToPoint_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolo_depth_interfaces__srv__MoveToPoint_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yolo_depth_interfaces__srv__MoveToPoint_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!yolo_depth_interfaces__srv__MoveToPoint_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
