...
# 1) e0509 (joint position 제어)
gym.register(
    id="Isaac-Lift-Cube-Franka2-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        # 여기만 e0509용 EnvCfg로 교체
...
# 3) 기존 Franka
gym.register(
    id="Isaac-Lift-Tableware-Franka-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Tableware-Franka-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Tableware-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Tableware-Teddy-Bear-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
...
gym.register(
    id="Isaac-Lift-Tableware-Franka-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
